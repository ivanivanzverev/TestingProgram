...
mkdir "%OUT_PROJECT_PATH%" "%OUT_BIN_PATH%" "%OUT_JRE_PATH%" "%OUT_LIB_PATH%" "%OUT_DOC_PATH%"
...
::copy doc
xcopy "%CURRENT_DIR_PATH%\doc\Tests" "%OUT_BIN_PATH%\doc\Tests" /s /i 
xcopy "%CURRENT_DIR_PATH%\doc\Example.txt" "%OUT_BIN_PATH%"  
